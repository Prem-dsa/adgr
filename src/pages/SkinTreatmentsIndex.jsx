...
import { skinServices } from '../data/servicesData';
        ...
        <section className="treatments-page">
            <div className="container">
                ...
                <motion.div
                    ...
                    variants={fadeUp}
                >
                    <span className="treatments-page__eyebrow">Skin Aesthetics</span>
                    <h1 className="treatments-page__title">
                        Skin <em>Treatments</em>
                    </h1>
                    <p className="treatments-page__subtitle">
                        Premium skincare protocols designed to restore youthful vitality
                        and natural luminosity. Reveal your radiance with expert care.
                    </p>
                </motion.div>
...
export default SkinTreatmentsIndex;
