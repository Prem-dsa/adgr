...
const SkinTreatments = () => {
    return (
        <section className="treatments-page section" id="skin-treatments">
            <div className="container">
                <div className="treatments-page__header">
                    <span className="section-eyebrow">Skin Aesthetics</span>
                    <h1 className="treatments-page__title">
                        Skin <em>Treatments</em>
                    </h1>
                    <p className="treatments-page__subtitle">
                        Advanced skincare solutions designed to reveal your natural radiance and youthful vitality.
                    </p>
                </div>
